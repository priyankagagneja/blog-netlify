...
Credits first: 
Thanks @jonthegeek for this [article](http://jonthegeek.com/2018/02/27/blogging-in-ten-minutes/) for the inpiration to get me started with my blog yay!! This is by far the best article I have used to achieve any data related tasks without making almost no mistakes/errors. 

Thanks also to Nick Strayer, Bryan Jenks and Mitchelle Harold and all those involved with the 2 packages I am going to write about in the rest of the blog. 
